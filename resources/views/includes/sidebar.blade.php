    ...
    <div class="blog-sidebar mt-5 mt-lg-0">
        ...
        <div class="single-widget-area popular-post-widget">
            ...
            <div class="single-populer-post d-flex">
                <img src="{{ asset('assets/img/sidebar-img/1.jpg') }}" alt="">
            ...
            <!-- Single Popular Post -->
            <div class="single-populer-post d-flex">
                <img src="{{ asset('assets/img/sidebar-img/2.jpg') }}" alt="">
                <div class="post-content">
                    <a href="#">
            ...
            <!-- Single Popular Post -->
            <div class="single-populer-post d-flex">
                <img src="{{ asset('assets/img/sidebar-img/3.jpg') }}" alt="">
                <div class="post-content">
                    <a href="#">
            ...
            <!-- Single Popular Post -->
            <div class="single-populer-post d-flex">
                <img src="{{ asset('assets/img/sidebar-img/4.jpg') }}" alt="">
                <div class="post-content">
                    <a href="#">
            ...
            <!-- Single Popular Post -->
            <div class="single-populer-post d-flex">
                <img src="{{ asset('assets/img/sidebar-img/5.jpg') }}" alt="">
                <div class="post-content">
                    <a href="#">
        ...
        <div class="single-widget-area add-widget text-center">
            <div class="add-widget-area">
                <img src="{{ asset('assets/img/sidebar-img/6.jpg') }}" alt="">
                <div class="add-text">
