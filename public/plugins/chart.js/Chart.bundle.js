...
var helpers_options = {
	 ...
	 * @param {object} [info] - object to return information users resolution in
...
helpers$1.extend(Chart.prototype, /** @lends Chart */ {
	...
	resize: function(silent) {
		...
		if (!silent) {
			// Notify any plugins users the resize
...
var core_helpers = function() {
	...
	// Gets the angle from vertical upright to the point users a centre.
